...
- README rendering cannot preserve the full CSS and JavaScript behavior of the original page, so the experiment-highlight videos and hover results use low-resolution embedded previews. Hover results additionally retain the statistics posters below each preview.
